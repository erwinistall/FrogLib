...
import com.erwinherrera.froglib.controller.wpilibcontroller.RamseteController;
import com.erwinherrera.froglib.controller.wpilibcontroller.SimpleMotorFeedforward;
import com.erwinherrera.froglib.geometry.Pose2d;
import com.erwinherrera.froglib.kinematics.wpilibkinematics.ChassisSpeeds;
import com.erwinherrera.froglib.kinematics.wpilibkinematics.DifferentialDriveKinematics;
import com.erwinherrera.froglib.kinematics.wpilibkinematics.DifferentialDriveWheelSpeeds;
import com.erwinherrera.froglib.trajectory.Trajectory;

import java.util.function.BiConsumer;
import java.util.function.Supplier;

/**
 * A Behavior that uses a RAMSETE controller ({@link RamseteController}) to follow a trajectory
 * {@link Trajectory} with a differential drive.
 *
 * <p>The Behavior handles trajectory-following, PID calculations, and feedforwards internally.  This
...
public class RamseteBehavior extends BehaviorBase {
    ...
    /**
     * Constructs a new RamseteBehavior that, when executed, will follow the provided trajectory.
     ...
     */
    public RamseteBehavior(Trajectory trajectory,
