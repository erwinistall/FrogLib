...
import com.erwinherrera.froglib.kinematics.wpilibkinematics.MecanumDriveKinematics;
import com.erwinherrera.froglib.kinematics.wpilibkinematics.MecanumDriveMotorVoltages;
import com.erwinherrera.froglib.kinematics.wpilibkinematics.MecanumDriveWheelSpeeds;
...
/**
 * A Behavior that uses two PID controllers ({@link PIDController}) and a
 * ProfiledPIDController ({@link ProfiledPIDController}) to follow a trajectory
 * {@link Trajectory} with a mecanum drive.
 *
 * <p>The Behavior handles trajectory-following,
...
public class MecanumControllerBehavior extends BehaviorBase {
    ...
    /**
     * Constructs a new MecanumControllerBehavior that when executed will follow the provided
    ...
    public MecanumControllerBehavior(Trajectory trajectory,
