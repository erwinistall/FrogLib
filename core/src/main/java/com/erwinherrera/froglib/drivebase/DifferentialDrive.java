...
import com.erwinherrera.froglib.actuators.motors.MotorGroup;
...
public class DifferentialDrive extends RobotDrive {
    ...
    public void arcadeDrive(double forwardSpeed, double turnSpeed) {
        ...
        motors[MotorType.kLeft.value].swim(maxOutput * wheelSpeeds[0]);
        motors[MotorType.kRight.value].swim(rightSideMultiplier * maxOutput * wheelSpeeds[1]);
    }
    ...
    public void tankDrive(double leftSpeed, double rightSpeed) {
        ...
        motors[MotorType.kLeft.value].swim(wheelSpeeds[0] * maxOutput);
        motors[MotorType.kRight.value].swim(wheelSpeeds[1] * rightSideMultiplier * maxOutput);
    }
